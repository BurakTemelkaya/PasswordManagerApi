...
public class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        builder.Property(u => u.MasterPasswordSalt).HasColumnName("MasterPasswordSalt").HasMaxLength(64).IsRequired();
        builder.Property(u => u.MasterPasswordHash).HasColumnName("MasterPasswordHash").HasMaxLength(16).IsRequired();
